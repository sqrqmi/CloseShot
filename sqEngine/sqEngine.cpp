// sqEngine.cpp : アプリケーションのエントリ ポイントを定義します。
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_SQENGINE, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_SQENGINE));
    ...
    while ( 1 )
    {
        ...
        {
            //=========================================================
            // ウィンドウメッセージ処理（OSからの通知に対するリアクション処理）
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_SQENGINE));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   // ウィンドウのサイズを変更できないように、WS_THICKFRAMEは除外する
